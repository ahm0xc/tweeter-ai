...
export default function Hero({ className, ...props }: Props) {
  return (
    <section className={cn("", className)} {...props}>
      <div className="relative max-w-6xl min-h-[80vh] md:min-h-[75vh] lg:min-h-screen px-4 mx-auto sm:px-6">
        {/* Particles animation */}
        ...
        <div className="pt-32 pb-16 md:pt-52 md:pb-32">
          ...
          <div className="container mx-auto text-center">
            ...
            <h1 className="pb-4 font-heading font-extrabold [text-wrap:balance] tracking-tight text-transparent text-4xl md:text-5xl lg:text-8xl  bg-clip-text bg-gradient-to-br from-zinc-200/60 via-zinc-200 to-amber-200/80">
